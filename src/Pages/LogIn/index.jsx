        ...
        <Container>
            ...
            <div className="left-section">
                <div className="left-section-content">
                    ...
                    <div className='img-box'><img src={img} alt="img" /></div>
                </div>
            </div>
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="form">
                        ...
                        <div className='pass-input'>
                            ...
                            {this.state.errors.password && this.state.isValid===false? <Error className="errors">{this.state.errors.password}</Error> : null}


                            <div>
                                <img src={this.state.showPassword ?hideEye : showEye}
                                alt="eye" 
                                className='eye' 
                        ...
                        <p className="final-stat">Don’t have an account? 
                        <span> 
                            <Link to="/signUp" style={{color: "#1565d8"}}>Register</Link>
                        </span>
                        </p>
                    </div>
                </form>
